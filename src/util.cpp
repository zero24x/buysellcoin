...
int nAnonymizeBuysellAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Buysell
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Buysell
    // Mac: ~/Library/Application Support/Buysell
    // Unix: ~/.Buysell
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Buysell";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Buysell.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "buyselld.pid"));

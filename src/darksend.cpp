    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Buysellcoin and make it unusable. To
...
bool CDarksendPool::DoAutomaticDenominating(bool fDryRun)
{
    ...
    CAmount nBalanceNeedsAnonymized = nAnonymizeBuysellcoinAmount*COIN - pwalletMain->GetAnonymizedBalance();
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("Buysellcoin-darksend");
